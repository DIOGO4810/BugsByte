    ...
    <ScrollView style={styles.scrollView}>
      <View style={styles.container}>
        <View style={styles.headerContainer}>
          ...
          <View style={styles.header}>
            <View>
              <Image
                source={{ uri: data[search_id(data, id)].image }}
            ...
            <Text
              style={[
                ...
                {
                  color:
                    data[search_id(data, id)].price_change_percentage_24h >= 0
                      ? "green"
                      : "red",
                },
              ]}
      ...
      <View>
        <View style={styles.caixaPrevisao}>
          {predicts !== null ? (
            <Text style={styles.textoPrevisao}>
            Previsão de Preço: {(predicts.previsto ?? 0).toFixed(2)}€
          </Text>
          
          ) : (
            <Text style={styles.textoPrevisao}>Calculando previsão...</Text>
          )}
        </View>
        <View style={styles.caixaPrevisao}>
      ...
      <View style={styles.noticiasContainer}>
        <ScrollView
          ...
          contentContainerStyle={styles.noticiasContentContainer}
