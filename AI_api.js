...
async function GeminiCall(moedas) {
  try {
    const response = await ai.models.generateContent({
      ...
      contents: `Responde-me ao seguinte prompt em Português de Portugal. Resume as notícias mais relevantes sobre estas ${moedas} da última semana e não me contes mais informações sobre outras moedas. Concentra-te apenas nas criptomoedas que tiveram as maiores variações (quedas ou subidas). Explica brevemente os motivos por trás dessas mudanças. Limita a resposta a 3 linhas. Dá-me também uma possível direção do preço da moeda, mas apenas para cima ou para baixo, isto é, não dês valores numéricos.`,
    });
